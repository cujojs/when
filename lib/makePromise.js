...
define(function() {
	...
	return function makePromise(environment) {
		...
		EmptyHandler.prototype._env = environment.monitor;
		EmptyHandler.prototype._isMonitored = function() {
		...
		AsyncHandler.prototype._addTrace = function(trace) {
		...
		BoundHandler.prototype = Object.create(EmptyHandler.prototype);

		BoundHandler.prototype.inspect = function() {
			return this.join().inspect();
		};

		BoundHandler.prototype.join = function() {
			return this.handler.join();
		};
		...
		BoundHandler.prototype._addTrace = function(trace) {
			return this.handler._addTrace(trace);
		};
		...
		foreverPendingPromise = new InternalPromise(new EmptyHandler(), false);
