	...
	function makePromise(environment) {
		...
		function Promise(resolver) {
			...
			function promiseResolve(val) {
				p._handler = p._handler.resolve(p, val);
			}
			...
			function promiseReject(reason) {
				p._handler = p._handler.resolve(p, new RejectedPromise(reason));
			}
		...
		PendingHandler.prototype.resolve = function(p, x) {
			...
			return new ResolvedHandler(value);
		};

		PendingHandler.prototype._when = function(resolve, notify, f, r, u) {
			this.consumers.push(function(p) {
		...
		PendingHandler.prototype.notify = function(x) {
			...
			enqueue(function () {
				runHandlers(queue, new ProgressingPromise(x));
			});
		};
		...
		ResolvedHandler.prototype.inspect = function() {
			return this.value.inspect();
		};

		ResolvedHandler.prototype.resolve = function() {
			return this;
		};

		ResolvedHandler.prototype._when = function(resolve, notify, f, r, u) {
			var self = this;
			enqueue(function() {
				self.value._when(resolve, notify, f, r, u);
			});
		};

		ResolvedHandler.prototype.notify = function() {};
		...
		Promise.prototype._when = function(resolve, notify, f, r, u) {
			this._handler._when(resolve, notify, f, r, u);
		};
