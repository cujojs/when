...
define(function() {
	...
	return function makePromise(environment) {
		...
		Fulfilled.prototype.fold = function(f, z, c, to) {
			runInContext3(f, z, this, c, to);
		};

		Fulfilled.prototype.when = function(cont) {
			runInContext(cont.fulfilled, this, cont.receiver, cont.resolver);
		};
		...
		Rejected.prototype.when = function(cont) {
			this._unreport();
			runInContext(cont.rejected, this, cont.receiver, cont.resolver);
		};
		...
		function runInContext3(f, z, h, receiver, to) {
			if(typeof f !== 'function') {
				return to.become(h);
			}

			Promise.enterContext(h);
			var x = tryCatchReject3(f, z, h.value, to, receiver);
			Promise.exitContext();
