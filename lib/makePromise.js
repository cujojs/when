	...
	return function makePromise(environment) {
		...
		Promise.prototype._beget = function () {
			if(typeof Pending !== 'function') {
				console.log('****Pending not a function', typeof Pending, Pending, Pending == null ? Pending : Pending.toString());
				console.log(Promise.prototype._beget.toString());
			}
			if(typeof this.constructor !== 'function') {
				console.log('****this.constructor not a function', typeof this.constructor, this, this.constructor, this.constructor == null ? this.constructor : this.constructor.toString());
				console.log(Promise.prototype._beget.toString());
			}
			var parent = this._handler;
