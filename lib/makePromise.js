...
define(function() {
	...
	function makePromise(environment) {
		...
		/**
		 * Call a resolver to seal its promise's fate
		 */
...
//				return new FollowingHandler(x);
		...
		DeferredHandler.prototype.inspect = function() {
			return this.resolved ? this.handler.inspect() : toPendingState();
		};
		...
		DeferredHandler.prototype.when = function(resolve, notify, receiver, f, r, u) {
			if (this.resolved) {
				this.handler.when(resolve, notify, receiver, f, r, u);
			} else {
		...
		FollowingHandler.prototype.when = function(resolve, notify, receiver, f, r, u) {
			...
			this.handler.when(resolve, notify, this.receiver === void 0 ? receiver : this.receiver, f, r, u);
		};
		...
		FollowingHandler.prototype.resolve = FollowingHandler.prototype.reject = FollowingHandler.prototype.notify
			= FulfilledHandler.prototype.resolve = FulfilledHandler.prototype.reject = FulfilledHandler.prototype.notify
			= RejectedHandler.prototype.resolve = RejectedHandler.prototype.reject = RejectedHandler.prototype.notify
			= noop;
