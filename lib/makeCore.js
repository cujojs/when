...
define(function() {
	...
	var bind, uncurryThis, call, undef;
	...
	function makeCore(environment) {

		var enqueue, monitorApi;
		...
		Promise.prototype.spread = function(onFulfilled) {
			return all(this).then(function(array) {
		 ...
		 * @deprecated
		 */
		Promise.prototype.always = function(onFulfilledOrRejected, onProgress) {
		...
		function all(array) {
			return cast(array).then(resolveAll);

			function resolveAll(array) {
